...
- **项目使用**: `modules/circuit/src/polaris_circuit/simulator.py` 的 `simphony_models()` 集成 SiEPIC 模型库
...
- **安装**: `pip install sax`
- **项目使用**: `modules/circuit/src/polaris_circuit/cascade.py` 直接用 sax
...
- **项目使用**: `modules/circuit/src/polaris_circuit/models.py` 复刻 SiPANN 的 S 参数模型
