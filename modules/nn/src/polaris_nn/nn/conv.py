...
从 v4 旧包 ``src/polaris/nn/conv.py`` 迁移，``Tensor``/``Module`` 改为从
``polaris_nn.nn.layers`` + ``polaris_core`` 导入。
...
- Chellapilla et al., 2006, im2col 高性能卷积
  https://www.semanticscholar.org/paper/High-Performance-Convolutional-Neural-Networks-for-Chellapilla-Puri/8e880a9d89b75b7d4c5b4b0e6e5a8b8c0a8b8b8b
...
from polaris_nn.nn.layers import Module, _init_weight
...
class Dropout(Module):
    ...
    - PyTorch torch.nn.Dropout
      https://pytorch.org/docs/stable/generated/torch.nn.Dropout
    """
