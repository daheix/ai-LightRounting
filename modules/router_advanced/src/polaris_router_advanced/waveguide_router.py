...
# noqa: F401 表示这些导入是有意的重导出，供上层 `from .waveguide_router import ...` 使用
from .obstacle_grid import ObstacleGrid, auto_grid_size  # noqa: F401
from .path_geometry import (  # noqa: F401
    arc_bend,
    check_min_spacing,
    count_crossings,
    equalize_length,
