...
与 C03-Redheffer 星积（``polaris_multiphysics.rcwa.smatrix``）共享 BlockSMatrix
...
from polaris_multiphysics.rcwa.solver_1d import (
    GratingLayer1D,
    RcwaConfig1D,
    RcwaResult1D,
    solve_rcwa_1d,
)
from polaris_multiphysics.rcwa.solver_2d import (
    GratingLayer2D,
    RcwaConfig2D,
    RcwaResult2D,
    solve_rcwa_2d,
