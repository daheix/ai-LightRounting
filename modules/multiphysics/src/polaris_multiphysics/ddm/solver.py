...
`from polaris_multiphysics.ddm.solver import X` 路径完全不变。
...
# `from polaris_multiphysics.ddm.solver import _xxx` 复用，标 noqa: F401 避免 ruff 误删。
from polaris_multiphysics.ddm._equilibrium import (
...
from polaris_multiphysics.ddm._newton import run_newton as _run_newton_fn
from polaris_multiphysics.ddm._postprocess import (
...
from polaris_multiphysics.ddm.poisson import PoissonSolver
from polaris_multiphysics.ddm.scharfetter_gummel import (
    K_B,
    MU_N_SI,
    MU_P_SI,
    N_I_SI,
