...
从 v4 ``polaris.sim.parasitic_capacitance`` 迁移至 polaris-parasitic 子模块
（R13: 不保留 v4 兼容路径）。纯 NumPy/SciPy CPU，R04 兼容。对齐 Cadence
Quantus QRC / Synopsys StarRC ScanBand 方法。
