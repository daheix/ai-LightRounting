...
| 文件 | 大小 | 路径 |
|------|------|------|
| showcase.jsonl | 994.6 KB | logs/showcase.jsonl |
...
| fdtd_results.json | 822 B | reports/fdtd_results.json |
...
| report.md | 19.3 KB | reports/report.md |
