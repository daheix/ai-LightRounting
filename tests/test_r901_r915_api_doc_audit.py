"""R901-R915"""R901-R915 API 文档覆盖率审计模块测试。

学术依据（R02，≥5 文献 URL）：
- PEP 257 Docstring Conventions https://peps.python.org/pep-0257/
- Sphinx napoleon Google 风格 https://www.sphinx-doc.org"""R901-R915 API 文档覆盖率审计模块测试。
...
- numpydoc docstring guide https://numpydoc.readthedocs.io/en/latest"""R901-R915 API 文档覆盖率审计模块测试。
...
- PEP 8 命"""R901-R915 API 文档覆盖率审计模块测试。
...
from polaris.sim.api_doc_audit_r901 import (
    ApiDocAuditor"""R901-R915 API 文档覆盖率审计模块测试。
...
PERF_TUNING = SIM_DIR / "perf_tuning_r85"""R901-R915 API 文档覆盖率审计模块测试。
...
def test"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_returns_report() -> None:
    ...
    assert report.document"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_returns_report() -> None:
    ...
    assert"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_returns_report() -> None:
    ...
    assert all(isinstance"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_docstring_coverage_high_for"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_docstring_coverage_high_for_new_module() -> None:
    """R902-R906 新模块 perf_tuning_r"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_docstring_coverage_high_for_new_module() -> None:
    ...
    report = audit_file(PERF_TUNING)
    assert report.docstring_coverage >="""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_docstring_coverage_high_for_new_module() -> None:
    ...
    assert report.docstring_coverage >= 0.95, (
        f"perf_tuning_r851 docstring 覆盖"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_memory_optimization_high_coverage() -> None:
    """R902-R906 memory_optimization_r886 覆盖率 ≥95%。"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_nonexistent_raises"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_module_docstring_detected() -> None:
    ...
    report = audit_file(PERF_TUNING)
    assert report.module"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_syntax_error_recorded(tmp_path) -> None:
    """R03 语法错误记录但不 raise（"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_syntax_error_recorded(tmp_path) -> None:
    ...
    report ="""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    """R903-R904 Args/Returns"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    ...
    src = textwrap.dedent(
        '''
        def good_func(x"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    ...
    src = textwrap.dedent(
        ...
        def good_func(x):
            ...
            Example:
                >>> good"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    ...
    src = textwrap.dedent(
        ...
        def poor"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    ...
    f.write_text(src, encoding="utf-8"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    ...
    report = audit_file(f)
    names = {e.name: e for e in report"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    ...
    assert names["good_func"]."""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    ...
    assert names"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_detects_args_returns_sections(tmp_path) -> None:
    ...
    assert names["poor_func"]."""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_class_methods_detected(tmp_path) -> None:
    """R907-R908 类与公开方法"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_class_methods_detected(tmp_path) -> None:
    ...
    src = textwrap.dedent(
        '''
        class"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_file_class_methods_detected(tmp_path) -> None:
    ...
    assert "_private_method" not"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_module_path_returns_dict() -> None:
    ...
    assert len(reports) >"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_module_path_returns_dict() -> None:
    ...
    for k, r in reports.items"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_module"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_audit_module_path_nonexistent_raises() -> None:
    """R03 目录不存在 raise。"""
    with pytest"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_threshold_fail(tmp_path) -> None"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_threshold_fail(tmp_path) -> None:
    ...
    f = tmp_path / "low.py"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_invalid_threshold_raises() ->"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_to_json_valid() -> None:
    """R912 JSON 报告"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_to_json_valid() -> None:
    """R912 JSON 报告导出有效。"""
    auditor = ApiDoc"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_missing"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_missing_details_structure() -> None:
    ...
    for d in details:
        ...
        assert "kind" in d
        assert "lineno" in d
        assert "missing""""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_missing_details_on"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_missing_details_on_poor_file(tmp_path) -> None:
    ...
    src = textwrap.dedent(
        '''
        def f1(x):
            """只有 docstring"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_missing_details_on_poor_file(tmp_path) -> None:
    ...
    src = textwrap.dedent(
        ...
        def f1(x):
            ...
            无 Args/Returns/Example"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_missing_details_on_poor_file(tmp_path) -> None:
    ...
    f = tmp_path / "poor"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_auditor_missing_details_on_poor_file(tmp_path) -> None:
    ...
    assert "Example" in details[0"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_has_section_fullwidth_colon() -> None:
    ...
    from polaris"""R901-R915 API 文档覆盖率审计模块测试。
...
def test_has_section_fullwidth_colon() -> None:
    ...
    assert _has_section(""""R901-R915 API 文档覆盖率审计模块测试。
...
def test_is_public_naming() -> None:
    """R901 公共 API"""R901-R915 API 文档覆盖率审计模块测试。
