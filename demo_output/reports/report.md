...
| 10 | optimal_width_nm | 365.52 | nm |
| 10 | improvement_db | 0.65 | dB |
| 10 | converged | false | - |
...
| 文件 | 大小 | 路径 |
|------|------|------|
| showcase.jsonl | 215.2 KB | logs/showcase.jsonl |
...
| fdtd_results.json | 813 B | reports/fdtd_results.json |
