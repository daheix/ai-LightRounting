...
批次 10-B 拆分说明（2026-07-01）:
    从 lvs_advanced.py 抽出 R187 带坐标的结构化 LVS 错误报告生成，
    对标 Cadence Pegasus LVS Results Viewer 的错误定位能力。
...
from polaris.sim.lvs_advanced_types import LocatedError, StructuredErrorReport
