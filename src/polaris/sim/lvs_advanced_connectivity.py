...
批次 10-B 拆分说明（2026-07-01）:
    从 lvs_advanced.py 抽出 R185 连接性提取与悬浮节点/孤立子图检测。
...
from polaris.sim.lvs_advanced_helpers import _bbox_um, _get_region, _load_layout
from polaris.sim.lvs_advanced_types import ConnectivityReport
