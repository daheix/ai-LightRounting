"""R26 路标：CAPHE 时域求解器与统一后端适配器。

本模块从 caphe_backend.py 拆分而来（规则 7.1 文件 < 800 行），
承载 CAPHE 时域 ODE 求解器与统一后端适配器。
...
# =============================================================================
# CAPHETimeDomainSolver — 时域 ODE 求解器（CMT）
# =============================================================================
...
# =============================================================================
# CAPHEBackend — CAPHE 后端适配器（统一频域+时域接口）
# =============================================================================
class CAPHEBackend:
    ...
    def simulate_frequency(
        ...
        """
        # 延迟导入避免循环依赖（CAPHEFrequencySolver 在 caphe_backend.py）
        from polaris.sim.caphe_backend import CAPHEFrequencySolver
...
__all__ = ["CAPHETimeDomainSolver", "CAPHEBackend"]
